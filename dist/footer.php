...
<footer class="w-full px-[4%] md:px-[8%] mb-10 md:flex justify-between">
    <div>
        ...
        <p class="text-sm max-sm:mb-2 text-black/80">Copyright © Built by <a class="text-[#0000FF] font-semibold" href="https://www.linkedin.com/in/hossanadev">Hossana</a> <?php echo date('Y'); ?>. All rights reserved.</p>
    </div>
